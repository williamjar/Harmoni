        ...
        return(
            <div className="search" >
                ...
                <div className="results" id="style-5">
                    {this.state.showSearchResults && this.state.results != undefined && this.state.results[0].contactName != undefined?
                    ...
                    {this.state.showSearchResults && this.state.results != undefined && this.state.results[0].eventName != undefined?
